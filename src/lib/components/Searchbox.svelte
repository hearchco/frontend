		...
		<div class="mx-4 w-full max-w-screen-md min-w-fit mt-2 mb-2 h-5 flex gap-1">
			{#each Object.values(CategoryEnum) as category}
				<button
					...
					class="capitalize flex items-center dark:text-white hover:border-hearchco-primary hover:dark:border-hearchco-secondary border-b-2 p-3 pb-4 duration-100 ease-in-out"
				>
					{category}
				</button>
			{/each}
