...
<div class="pt-40 mx-auto text-center">
	<h1 class="py-2 text-6xl sm:text-9xl font-black tracking-tight">
		{status}
	</h1>
	<p
		class="py-4 text-md sm:text-3xl font-bold tracking-tight text-neutral-900 dark:text-neutral-100"
	>
